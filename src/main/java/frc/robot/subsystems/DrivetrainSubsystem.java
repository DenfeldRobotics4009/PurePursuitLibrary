...
public class DrivetrainSubsystem extends SubsystemBase {
  ...
  String aPosMask(int i) {
    switch (i) {
      ...
      default: return "<InvalidInputError>";
    }
  }
  ...
  final RelativeEncoder[] a_mTencoder = {a_mTctrlr[0].getEncoder(), a_mTctrlr[1].getEncoder(),a_mTctrlr[2].getEncoder(), a_mTctrlr[3].getEncoder()};
  final CANCoder[] a_mCANTencoder = {new CANCoder(Constants.L1SE_), new CANCoder(Constants.R1SE_), new CANCoder(Constants.L2SE_), new CANCoder(Constants.R2SE_)};
  final RelativeEncoder[] a_mencoder = {a_mctrlr[0].getEncoder(), a_mctrlr[1].getEncoder(),a_mctrlr[2].getEncoder(), a_mctrlr[3].getEncoder()};
  ...
  public void periodic() {
    ...
    min = -max;
    // Display values
    SmartDashboard.putNumber("MinTurning", max);
